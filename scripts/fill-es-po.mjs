...
const es = {
  ...
  "No briefing yet": "Aún no hay briefing",
  "No evaluation yet": "Aún no hay evaluación",
  "No evaluation yet - Create": "Aún no hay evaluación - Crear",
  "Open briefing": "Abrir briefing",
  "Open evaluation": "Abrir evaluación",
  ...
  Project: "Proyecto",
  "8h": "8h",
  "Set %{hours} hours": "Establecer %{hours} horas",
